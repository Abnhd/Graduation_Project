                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(right: 15),
                        child: Text("نوع المستلمين",style:fontstyle.fontheading),
                      ),
                      SizedBox(height: 6),
                      Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          value: widget.selectedRecipientType,
                          onChanged: (newValue) {
                            widget.onRecipientTypeChanged(newValue!);
                          },
                          items: ['طلاب', 'استاذ', 'الكل'].map((type) {
